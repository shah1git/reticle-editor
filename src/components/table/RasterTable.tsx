            ...
            <table className={styles.table}>
              <thead>
                <tr>
                  ...
                  <th><span className={styles.thContent}>ошибка<Tooltip text="Отклонение фактической позиции от идеальной в пикселях. Положительное значение (+) — метка сдвинута дальше от центра. Отрицательное (−) — ближе к центру. Чем ближе к нулю — тем точнее" /></span></th>
                  <th><span className={styles.thContent}>шаг<Tooltip text="Расстояние в пикселях от предыдущей метки до текущей. В идеале все шаги равны. Если шаг подсвечен оранжевым — он отличается от стандартного шага для этого крыла" /></span></th>
                </tr>
              </thead>
              <tbody>
                {marks.map(m => (
