  ...
  return (
    <div className={styles.section}>
      <div className={styles.titleRow}>
        <span className={styles.title}>СРАВНЕНИЕ СТРАТЕГИЙ</span>
      </div>
      ...
      <div className={styles.tableWrap}>
        <table className={styles.table}>
          <thead>
            <tr>
              <th></th>
              <th><span className={styles.thContent}>макс.<Tooltip text="Наихудшая ошибка позиционирования метки на всей сетке в пикселях. Чем меньше — тем точнее расположены метки. Максимально возможная ошибка при округлении — ±0.5 пикселя" align="left" /></span></th>
              <th><span className={styles.thContent}>средн.<Tooltip text="Средняя ошибка по всем меткам сетки. Показывает типичную погрешность — насколько в среднем метки отклоняются от идеальных позиций" align="left" /></span></th>
              <th><span className={styles.thContent}>дроб.<Tooltip text="Сколько меток имеют ненулевую ошибку — их идеальная позиция в пикселях дробная и была округлена. Формат: количество с ошибкой / всего меток" align="left" /></span></th>
              <th><span className={styles.thContent}>нер.<Tooltip text="Сколько расстояний между соседними метками отличаются от основного шага. При стратегии Б всегда 0 — все шаги равны. При А и В часть шагов короче или длиннее на 1 пиксель" align="left" /></span></th>
                  ...
                  <td className={styles.checkCell}>
                    {isBest && (
                      <>
                        ...
                        {!isCurrentOptimal && !isCurrent && <span className={styles.recommend}>рек.</span>}
                      </>
                    )}
                  </td>
                </tr>
